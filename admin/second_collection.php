                    ...
                    <div class="row col-xs-12">
                        <div class='box'>
                                ...
                                <div class='table-toolbar'>
									<div class='btn-group'>
										<a class='btn  btn-primary' href='print_fee_collection.php' target='_blank' ><i class='fa fa-print'></i>  Print</a>
									</div>
							...
							echo "
								<tr>
									...
									<td style='text-align:center;'><a href='invoice.php?fid=".$row['fid']."' target='_blank'><i class='fa fa-print'></i></a></td>
