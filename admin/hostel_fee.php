						...
						<div class="col-md-6">
						    ...
						    <div class='alert alert-warning' style='overflow-x:auto'>
						        <table class='table table-bordered table-hover'>
                                    <tr>
                                        <th>राशि</th>
                                        <th class='text-right'> 840.00</th>
                                    </tr> 
                                    <tr>
                                        <th>राशि(शब्दों में)</th>
                                    
                                        <th class='text-right'>आठ सौ चालीस रूपये </td>
                                    </tr>
                                </table>
						    ...
						    <div class='alert alert-danger'>
						        ...
						        <ul class='list-unstyled'>
						            ...
						            <li>Step 2 : For Payment Hostel Fee, Click on Proceed to Pay.</li>
						        </ul> 
						        <hr>
						        <p>If Hostel Fee mismatched then Don't Pay, contact Mr. Kunal Mahto, Lecturer (CSE) - <a href='tel:9470312947'>9470312947</a></p>
						  </div>
						<?php
						////////
							...
							$AdditionalInfo6=10;//pcode - payment code
							//$Filler1="";
							//$BankID="";
							//$Filler2="";
							//$Filler3="";
					...
					<script type="text/javascript">
							function validateForm() {
								...
								retry_attempt_count: 3},
										callbackUrl:'https://www.gpadp.org.in/admin/hostelgpay.php'
						...
						<div class="col-md-6">
                            ...
                            <?php
                            	...
                            	<tr>
									...
									<td style='text-align:center;'><a href='hostel_invoice.php?fid=".$row['fid']."' target='_blank'><i class='fa fa-file'></i></a></td>
                                </tr>";
								    }
