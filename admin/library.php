        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <div class="row col-xs-12">
                        <div class='box'>
                                <div class='box-header'>
                                    <h3 class='box-title'>Available Book Details</h3>   
                    ...
                    <!-- top row -->
					<?php
					if(studentBooksExists($student['cid']))
					{
						
					$allbsl=fetchAllIssueBook($student['cid']);
					echo"
                    <div class='row col-xs-12'>
                        <div class='box'>
                                <div class='box-header'>
                                    <h3 class='box-title'>Issued Book History</h3>   
                            ...
                            <tbody>";
								...
								foreach ($allbsl as $row){
									if($row['deposit_date']==null){
										$dDate="N/A";
									}
									else{
										$dDate=date( "j M, Y", strtotime($row['deposit_date']));
									}
									/////////////
								echo"
                            	<tr>
