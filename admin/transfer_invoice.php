...
@media print {
    ...
    <div class="invoice overflow-auto">
        <div style="min-width: 600px">
			...
			list($f1,$f2,$f3,$f4,$f5)  = feeCalc($student['category'],$student['tfw'],$student['gender'],2); 
            ...
            <main>
                <div class="row contacts">
                    <div class="col invoice-to">
						...
						<?php
							if($student['adm_date']=="")
							{
							    ...
							    if($student['adm_type']==1){
							        echo"<div class='address'><strong>Session </strong> - 2021-22(New Admission) </div>";
							    }
							    else{
							        echo"<div class='address'><strong>Session </strong> - 2021-22(Lateral) </div>";
						...
						<div class="address"><strong>Year</strong> - First Year/Second Year(Lateral)</div>
						...
						<tbody>
							<tr>
								...
								<td class="unit" rowspan="4">
									...
									<p><?php echo $fdata['authstatus']; 
									    if($fdata['authstatus']==300){
									        echo " - Success";
									    }
									    else {
									        echo " - Failure";
                ...
                <div class="notices">
                    <div>NOTICE:</div>
                    <div class="notice">Deposit this receipt with First Year Admission Receipt on Fee Collection Department, Government Polytechnic Adityapur.</div>
                </div>
            </main>
            <footer>
