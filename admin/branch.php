...
//Add New Book on Book List
		if(!empty($_POST)) {
			...
			if($bname == "")
			{
				$errors[] = lang("ENTER_BRANCH_NAME");
			}
			
			if(empty($errors)) {
				$successes[] = lang("BRANCH_ADD_SUCCESSFUL");
				$addb=addBranch(strtoupper($bname));
				$allb=fetchAllBranch();
				//////////////////////
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        <i class="ion ion-document-text"></i> Branch List
                        <small>Home</small>
                    </h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><i class="ion ion-document-text"></i> Branch</li>
                    </ol>
                </section>
                    ...
                    <div class="row col-xs-12">
                        <div class='box'>
                                <div class='box-header'>
                                    <h3 class='box-title'>Branch List Available Here</h3>   
