                                ...
                                <div class='table-toolbar'>
									...
									<div class='btn-group pull-right'>
										...
										<ul class='dropdown-menu pull-right'>
											<li><a href='print_books.php' target='_blank' ><i class='fa fa-print'></i> Print</a></li>
											<li><a href='save_books.php' target='_blank'><i class='fa fa-file-pdf-o'></i> Save as PDF</a></li>
											<li><a href='save_books_excel.php' target='_blank'><i class='fa fa-file-excel-o'></i> Export to Excel</a></li>
										</ul>
