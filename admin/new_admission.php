...
if(!empty($_POST))
{
	...
	{	
		...
		$user = new User($mobile,$name,$mobile,$email,4);
		addNewStudent($cid,$name,$father_name,$mother_name,$newdate,$gender,$branch,$sem,$category,$adm_type,$tfw,$at,$post,$city,$dist,$state,$pin,$cat,$cpost,$ccity,$cdist,$cstate,$cpin,$mobile,$email,$date);
		////////////////////////////////
				...
				<form name='newUser' action='".$_SERVER['PHP_SELF']."' method='post' id='formID'>
					...
					<div class='col-sm-12'>
						...
						<div class='row'>
							...
							<div class='col-sm-4 form-group'>
                    			<label class='control-label col-sm-3'>TFW</label>
                    				<div class='col-sm-6'>
                        				<div class='row'>
                            				<div class='col-sm-4'>
                                				<label class='radio-inline'>
