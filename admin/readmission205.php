        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
					...
					<div class="row">
						<div class="col-md-6">
						    <div class='alert alert-danger'>If you have valid Admission Permission Receipt then Pay Now! This is under maintainance</div>
						<?php
						////////
					...
					<script type="text/javascript">
							function validateForm() {
								...
								retry_attempt_count: 3},
										callbackUrl:'https://www.gpadp.org.in/admin/gpaystatus1.php'
						...
						<div class="col-md-6">
                            ...
                            <?php
                            	...
                            	<tr>
									...
									<td style='text-align:center;'><a href='readmission5_invoice.php?fid=".$row['fid']."' target='_blank'><i class='fa fa-file'></i></a></td>
                                </tr>";
								}
