...
foreach ($allNotice as $notice) {
	...
	<td style='text-align:center'>".date( "d-M-Y", strtotime($notice['date']))."</td>
	<td style='text-align:center'>
	<a onClick='return confirmSubmit()' href='notice_edit.php?id=".$notice['id']."' class='button icon edit primary'>Edit</a>
	</td>
	</tr>";
	}
