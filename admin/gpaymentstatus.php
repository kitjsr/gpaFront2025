...
$date=date("Y-m-d h:i:s");
		$servername = "localhost";
			$username = "gpaac_panditidkun";
			$password = "Nh2He[tZ,M4w";
			$dbname = "gpaac_gpakun";
			$prefix = "";
			// Create connection
  ...
  die("Connection failed: " . $conn->connect_error);
							...
							*/
							//
								...
								$sql = "INSERT INTO `fee_collection` ( `sid`, `cid`, `pcode`, `trno`, `brno`, `amount`, `authstatus`, `txndate`, `date`) VALUES ('".$cid."','".$cid."','".$pcode."','".$trno."','".$brno."','".$amount."','".$authstatus."','".$txndate."','".$date."')";
