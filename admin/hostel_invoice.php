    ...
    <div class="invoice overflow-auto">
        <div style="min-width: 600px">
            ...
            <main>
                <div class="row contacts">
                    <div class="col invoice-to">
						...
						<?php
								...
								echo"<div class='address'><strong>Session </strong> - 2021-22 </div>
					...
					<table border="0" cellspacing="0" cellpadding="0">
						...
						<tbody>
							<tr>
								...
								<td class="total">&#8377; <?php echo number_format(840,2); ?></td>
							</tr>
						...
						<tfoot>
							<tr>
								...
								<td colspan="2">&#8377; <?php echo number_format(840,2); ?></td>
							</tr>


							<tr>
								<td colspan="2">TOTAL</td>
								<td colspan="2" style="text-transform: capitalize;"><?php echo "".convert_number_to_words(840)." only"; ?></td>
							</tr>
						</tfoot>
					</table>
				</div>
                ...
                <div class="notices">
                    <div>NOTICE:</div>
                    <div class="notice">Deposit this receipt on Cash Section, Government Polytechnic Adityapur.</div>
                </div>
            </main>
            <footer>
