						...
						<div class="col-md-6">
						    ...
						    <div class='alert alert-warning' style='overflow-x:auto'>
						        <table class='table table-bordered table-hover'>
                                    <tr>
                                        <th colspan='6' class='text-center'> दुसरे वर्ष का शुल्क संरचना </th>
                                    </tr> 
                                    <tr>
						    ...
						    <div class='alert alert-danger'>
						        ...
						        <ul class='list-unstyled'>
						            ...
						            <li>Step 2 : For Payment Second Year Admission Fee Click on Proceed to Pay.</li>
						        </ul> 
						        <hr>
					...
					<script type="text/javascript">
							function validateForm() {
								...
								retry_attempt_count: 3},
										callbackUrl:'https://www.gpadp.org.in/admin/secondgpay.php'
						...
						<div class="col-md-6">
                            ...
                            <?php
                            	...
                            	<tr>
									...
									<td style='text-align:center;'><a href='second_invoice.php?fid=".$row['fid']."' target='_blank'><i class='fa fa-file'></i></a></td>
                                </tr>";
								}
