            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <div class='row'>
                        ...
                        <!-- ./col -->
                        <div class='col-lg-3 col-xs-6'>
                            <form method='POST' action='fee2021_process.php'>
                                <label>Purpose</label>
                                <select>
                                    <option value=''>--- Choose Option --</option>
                                    <option value='101'>First Year (P101)</option>
                                    <option value='101'>First Year (P101)</option>
                                </select>
                            </form>
                        </div><!-- ./col -->
					    ...
					    <div class='col-12'>
					        <div class='alert alert-danger'>
						        ...
						        <ul class='list-unstyled'>
						            <li>Step 1 : Goto <b>Fee Deposit Examination Fee</b></li>
						            <li>Step 2 : For Payment Examination Fee  Click on Proceed to Pay.</li>
						        </ul> 
						        <hr>
