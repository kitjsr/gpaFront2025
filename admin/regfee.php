						...
						<div class="col-md-6">
						    ...
						    <div class='alert alert-danger'>
						        ...
						        <ul class='list-unstyled'>
						            <li>If Receipt not generated automatically then Send Payment Details to Mr. Kunal Mahto, Lecturer (CSE) - <a href='tel:9470312947'>9470312947</a></li>
						        </ul> 
						        <hr>
						        <p>If Examination Fee mismatched then Don't Pay, contact Mr. Kunal Mahto, Lecturer (CSE) - <a href='tel:9470312947'>9470312947</a></p>
						  </div>
						<?php
						////////
					...
					<script type="text/javascript">
							function validateForm() {
								...
								retry_attempt_count: 3},
										callbackUrl:'https://www.gpadp.org.in/admin/regpay.php'
						...
						<div class="col-md-6">
                            ...
                            <?php
                            	...
                            	<tr>
									...
									<td style='text-align:center;'><a href='reg_invoice.php?fid=".$row['fid']."' target='_blank'><i class='fa fa-file'></i></a></td>
                                </tr>";
								    }
