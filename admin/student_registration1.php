				...
				<form name='newUser' action='".$_SERVER['PHP_SELF']."' method='post' id='formID'>
					...
					<div class='col-sm-12'>
						...
						<div class='row'>
							<div class='col-sm-4 form-group'>
								<label>At</label> 
								<input type='text' placeholder='Enter At/Post' class='form-control validate[required]' autocomplete='off' name='at' data-prompt-position='bottomLeft'  onchange=\"AutoFillAddress(this.form)\">
							</div>	
							<div class='col-sm-4 form-group'>
								<label>Post</label>
