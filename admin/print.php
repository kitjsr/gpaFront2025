            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><i class="fa fa-print"></i> Print</li>
                    </ol>
                </section>
                    ...
                    <div class='row'>
                        <div class='col-lg-3 col-xs-6'>
                            ...
                            <div class='small-box bg-aqua'>
                                ...
                                <a href='barcode_print.php' class='small-box-footer'>
                        ...
                        <div class='col-lg-3 col-xs-6'>
                            ...
                            <div class='small-box bg-green'>
                                ...
                                <a href='college_id_print.php' class='small-box-footer'>
                                    More info <i class='fa fa-arrow-circle-right'></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        <div class='col-lg-3 col-xs-6'>
                            ...
                            <div class='small-box bg-yellow'>
                                ...
                                <a href='student_data_print.php' class='small-box-footer'>
                                    More info <i class='fa fa-arrow-circle-right'></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
