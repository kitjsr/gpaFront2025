    ...
    <div class="invoice overflow-auto">
        <div style="min-width: 600px">
            ...
            <main>
                    ...
                    <div class="col invoice-to">
						...
						<?php
							if($student['adm_date']=="")
							{
								...
								echo"<div class='address'><strong>Session </strong> - 2019-22 </div>
						...
						<div class="address"><strong>Semester</strong> - 3rd</div>
					...
					<table border="0" cellspacing="0" cellpadding="0">
						...
						<tbody>
							<tr>
								...
								<td class="unit" rowspan="4">
									<p><?php echo "Transaction Id - ".$fdata['trno'].""; ?></p>
								...
								<td class="total">&#8377; <?php echo number_format(1000,2); ?></td>
							</tr>
							<tr>
								<td class="no"></td>
								<td class="text-left"><h3>
						...
						<tfoot>
							<tr>
								...
								<td colspan="2">&#8377; <?php echo number_format(1000,2); ?></td>
							</tr>


							<tr>
								<td colspan="2">TOTAL</td>
								<td colspan="2" style="text-transform: capitalize;"><?php echo "".convert_number_to_words(1000)." only"; ?></td>
							</tr>
						</tfoot>
					</table>
				</div>
                ...
                <div class="notices">
                    <div>NOTICE:</div>
                    <div class="notice">Don't Send/Deposit Fee Receipt to Fee Collection Department, Government Polytechnic Adityapur.</div>
                </div>
            </main>
            <footer>
