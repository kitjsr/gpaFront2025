					...
					<div class='col-sm-12'>
						...
						<div class='row'>
							<div class='col-sm-4 form-group'>
								...
								<input type='text' name ='broll' placeholder='Enter Board Roll No.' class='form-control validate[required]' autocomplete='off' data-prompt-position='bottomLeft' data-inputmask='\"mask\": \"99999999999\"' data-mask>
							</div>	
							<div class='col-sm-4 form-group'>
								<label>Class Roll No</label>
								<input type='text' name='roll' placeholder='Enter Class Roll No' class='form-control validate[required]' autocomplete='off' data-prompt-position='bottomLeft' >
							</div>	
							<!--
							<div class='col-sm-4 form-group'>
